                ...
                <div className="glass-panel p-8">
                    <div className="flex items-center gap-3 mb-8 border-b border-white/10 pb-6">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 text-sm">Add new products to the store database</p>
                        </div>
                    </div>

                    {msg && (
                        <div className={`p-4 rounded-lg mb-6 ${msg.includes('success') ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-red-500/10 text-red-500 border border-red-500/20'}`}>
                            {msg}
                        </div>
                    )}
