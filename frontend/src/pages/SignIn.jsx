    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="glass-panel w-full max-w-md p-8 relative z-10">
                <h2 className="text-3xl font-bold mb-2 text-center text-transparent bg-clip-text bg-gradient-to-r from-primary to-cyan-300">Welcome Back</h2>
                <p className="text-sky-200/50 text-center mb-8">Sign in to your LuxeStore account</p>
